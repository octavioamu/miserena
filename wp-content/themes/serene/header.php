...
<body <?php body_class(); ?>>
	<div id="container">
		<header id="main-header" class="clearfix">
			...
			<?php endif; ?>
			<?php if ( false !== ( $instagram_url = get_theme_mod( 'instagram_url' ) ) && '' !== $instagram_url ) : ?>
				<li class="et-social-icon et-social-instagram">
					<a href="<?php echo esc_url( $instagram_url ); ?>" target="_blank"><span><?php esc_html_e( 'Instagram', 'Serene' ); ?></span></a>
				</li>
			<?php endif; ?>
